...
class merge_onehotvector_columns:
    ...
    def __init__(self,attr_min_num,info_file,merge_column_file):
        ...
        self.file=info_file
        self.merge_column_file= merge_column_file#'/Users/zhang.xiaoya/Desktop/re_attributes.txt'
        # image selection
    ...
    def merge_columns(self): 
        ...
        for keys,values in self.merge_dic().items():
            ...
            if count%10==0:
                print (count)
        self.df.to_csv(base_path+'info_processed_0717_biggerthan{}.csv'.format(self.attr_min_num),index=False)
